...
export const SIGNAL_REGISTRY = {
  ...
  "discovery.source_selected": { category: "discovery", client: true, properties: { source_mode: { type: "enum", values: ["text", "url", "images", "document"] } } },
  ...
  "discovery.jump_in_auth_requested": { category: "discovery", client: true, properties: {
    source_mode: { type: "enum", values: ["text", "url", "images", "document"] },
